...
const Navbar = () => {
 ...
 <div className={styled.flex}>
      ...
      <Link to="project" hashSpy={true}
              ...
              delay={100}
              duration={500}
              className={styled.left}>Projects</Link>
      </div>
      <div className={styled.left}>
     <Link to="contact" hashSpy={true}
      ...
      <div className={styled.left}>
       <a className={styled.p1} href="https://drive.google.com/file/d/1lKz3pYkdCECLfSu5xj3BYq1z3CuQ-Joi/view?usp=sharing" target={"_blank"}>Resume</a>
      </div>
